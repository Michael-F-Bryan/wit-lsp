...
//!
//! Copied from [`crates/text-edit/src/lib.rs`][hash] in *Rust Analyzer*.
//!
//! [hash]: https://github.com/rust-lang/rust-analyzer/blob/c4618fe14d39992fbbb85c2d6cad028a232c13d2/crates/text-edit/src/lib.rs
...
impl Indel {
    pub fn insert(offset: TextSize, text: String) -> Indel {
        Indel::replace(offset..offset, text)
    }
    ...
    pub fn apply(&self, text: &mut String) {
        let TextRange { start, end } = self.delete;
...
impl TextEdit {
    ...
    pub fn insert(offset: usize, text: String) -> TextEdit {
...
impl TextEditBuilder {
    ...
    pub fn invalidates_offset(&self, offset: TextSize) -> bool {
        self.indels
            .iter()
            .any(|indel| indel.delete.contains(&offset))
    }
    ...
    indels
        ...
        .coalesce(|mut a, b| {
            if a.delete.end == b.delete.start {
                ...
                a.delete = a.delete.start..b.delete.end;
                Ok(a)
            } else {
                Err((a, b))
            }
...
mod tests {
    ...
    fn test_apply() {
        ...
        builder.insert(22, "_5555".to_owned());
