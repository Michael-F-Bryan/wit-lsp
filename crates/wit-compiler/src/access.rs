...
node_kinds! {
    ...
    Enum => (EnumItems, crate::queries::metadata::EnumMetadata),
    Flags => (FlagsItems, crate::queries::metadata::FlagsMetadata),
    Resource => (ResourceItem, crate::queries::metadata::ResourceMetadata),
    Variant => (VariantItems, crate::queries::metadata::VariantMetadata),
    ...
    StaticMethod => (StaticResourceMethod, crate::queries::metadata::StaticMethodMetadata),
